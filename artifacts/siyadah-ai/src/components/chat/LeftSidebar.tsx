  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center gap-1">
        ...
        <div
          className="w-8 h-8 rounded-full flex items-center justify-center text-xs font-semibold text-black mt-2"
    ...
    <Tooltip>
      <TooltipTrigger asChild>
        <button
          onClick={onClick}
          data-testid={testId}
          className="w-10 h-10 rounded-lg flex items-center justify-center text-white/40 hover:text-white hover:bg-white/5 transition-all duration-200"
        >
          {children}
        </button>
      </TooltipTrigger>
